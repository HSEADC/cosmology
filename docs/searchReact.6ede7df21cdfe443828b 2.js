...
var token = 'patJL5VC3LCgSnYyf.dd08f9b85c09acfd59260c7c8688a1ef252a6ff4b183b84c246c490ba7c94f6e';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('appbe3qKlLNb8b2d4');
...
;// ./src/components/M_PostTeaser.jsx
...
;// ./src/components/S_SearchContent.jsx
...
var S_SearchContent = function S_SearchContent(_ref) {
  ...
  (0,react.useEffect)(function () {
    getArticlesTeasers().then(setPostTeasers);
  }, []);
  (0,react.useEffect)(function () {
  ...
  var renderPostTeasers = function renderPostTeasers() {
    ...
    return postTeasers.filter(function (t) {
      return clean(t.title).includes(value);
    }).map(function (t) {
